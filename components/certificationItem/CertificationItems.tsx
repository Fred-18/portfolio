...
export default function CertificationItems({title, date, school,image}: iCertificate) {
    ...
    return (
        <>
            <article className={styles.certificate__container}>
                ...
                <img src={image} alt="Certification" className={styles.certificate__card__image}/>
